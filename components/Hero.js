...
const Hero = () => {
  return (
    <div className="flex  justify-between flex-col w-full md:border-b-[0.2px]">
      <div className=" h-[370px] md:h-[90vh] w-full  relative m-6 md:m-0 rounded-2xl md:rounded-none">
        <Image
          src="/hero.webp"
          alt="hero"
          fill
        ...
        <div className="absolute top-[40%] left-20 z-30 h-full  ">
          <p
            className={`${kugile.className} text-7xl md:text-7xl text-white font-bold`}
          >
            Silent
          </p>
          <p
          ...
          <h1
            className={` md:max-w-[400px] text-white font-semibold mt-3 md:mt-2 md:mb-4`}
          >
